...
<div style="padding: 10px 5px; background: aliceblue;">
    <h3 style="text-align: center;"><span style="padding: 5px; background: darkgray; ">আমার কথা</h3>
       <p>শ্রদ্ধেয় ভদন্তগণ এবং স্নেহের আবুসোগণ! </p> 
       <p>সবার প্রতি আমার হৃদয় নিংড়ানো বিনম্র শ্রদ্ধা ও স্নেহাশীষ নিবেদন করছি। আশা করি সবাই কুশলে আছেন এবং যার যার কর্তব্য নিয়ে ব্যস্ত সময় পার করছেন। </p> 
       <p> আপনারা হয়তো সবাই জানেন, বিগত কয়েকদিন আগে আমরা এই মহৎ উদ্যোগটি গ্রহণ করি যে, শ্রদ্বেয় শান্তরক্ষিত মহাস্থবির মহোদয়ের “পালি বাংলা অভিধান — ১ম ও ২য় খণ্ড” অভিধানটিকে পালি সাহিত্যানুরাগী ও বৌদ্ধ জনসাধারণের কাছে সহজলভ্য এবং ব্যবহারোপযোগী করে সুবিধাসম্বলিত একটি এন্ড্রয়েড এ্যাপস্ আকারে উপহার দেওয়ার এক মহৎ উদ্যোগ গ্রহণ করি। এজন্য আমরা সর্বপ্রথম কম্পোজিংয়ের কাজটি সাগ্রহে হাতে নিই। কম্পোজিং হচ্ছে খুব শ্রমসাধ্য একটা কাজ, আর এতবড় একটা অভিধান কম্পোজ করা তো একাই একজনের পক্ষে কোনোভাবেই সম্ভব নয়। যদি সম্ভব হলেও তা হবে অনেক সময়ের ব্যাপার। সেজন্যই আমরা কাজটাকে একটু সহজ করার জন্য আমাদের কয়েকজন মিলে ছোট্ট একটা টিম গঠন করি এবং কাজটা ভাগাভাগি করে শুরু করে দিই। আমাদের জন্য একটা শুভ সংবাদ যে, প্রথমে আমরা যে জনা দশেক শুরু করেছিলাম পরে তা বেড়ে পঞ্চদশোর্ধ হয়ে মোটামুটি এখন অষ্টাদশে। সে যাইহোক, এতবড় একটা কাজ দশে মিলে করি, করাতে নেই লাজ জিতি বা হারি। যারপরনাই আমিও খুশী যে কাজটা আরও তারাতারি এগোবে। তবে তা এগোবে মাত্র আমরা যদি নিয়মিত একনাগাড়ে কাজটি করে যায়। সেজন্য টিমের সকল সদস্যদের প্রতি আমার একটাই অনুরোধ, কাজটা নিয়মিতভাবে একনাগাড়ে করা হোক। যত দ্রুতই আমরা কাজটা করে যেতে পারি ততই উত্তম,
