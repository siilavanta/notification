...
var samadhikalyan = 'https://raw.githubusercontent.com/SamadhikalyanBhante/vol_1/master/%E0%A6%A8.txt'
    ...
    const topTen = () => {
            ...
            document.body.insertAdjacentHTML('afterbegin', '<p style="background: gray; padding: 2px 6px; font-size:12px; margin: 0px 0px 10px 0px;"><i>কেবল আনলাইনে জমা দেওয়া ডাটা নিয়ে র‌্যাঙ্কিং করা হয়েছে।</i></p> ')
